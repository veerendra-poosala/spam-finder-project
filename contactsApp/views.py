...
from profileApp.models import RegisteredUsersModel
        ...
        if len(user_input) == 10:
            try:
                ...
                if objs:
                    ...
                    try:
                        obj = RegisteredUsersModel.objects.get(phone_number=user_input)  
                    ...
                    except RegisteredUsersModel.DoesNotExist:
